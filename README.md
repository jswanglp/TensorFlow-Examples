...
- **Simple CNN with Dataset API** ([code](/examples/5_DataManagement/simple_cnn_dataset.py)). Using the tensorflow-dataset-based API to build a simple convolutional neural network to classify mnist data sets.
