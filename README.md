...
- **Logistic Regression (two classes)** ([code](https://github.com/jswanglp/TensorFlow-Examples/blob/master/examples/2_BasicModels/logistic_regression_2classes.py)). Implement a Logistic Regression with TensorFlow .
...
- **Autoencoder in colab** ([notebook](https://github.com/jswanglp/TensorFlow-Examples/blob/master/examples/3_NeuralNetworks/autoencoder_in_colab.py)). Build an auto-encoder to encode an image to a lower dimension and re-construct it in colab.
...
- **Simple example of GAN** ([notebook](notebooks/3_NeuralNetworks/Simple_GAN.ipynb)) ([code](examples/3_NeuralNetworks/simple_GAN.py)) ([image1](resources/img/gen_loss_and_disc_loss.jpg)) ([image2](resources/img/generated_images.jpg)). A simple example to show how to build a GAN.
...
- **Simple CNN with Dataset API** ([colab notebook](/notebooks/5_DataManagement/simple_cnn_dataset.ipynb)) ([code](/examples/5_DataManagement/simple_cnn_dataset.py)). Using the tensorflow-dataset-based API to build a simple convolutional neural network to classify mnist data sets.
